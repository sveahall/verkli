-- Rename role value from 'author' to 'author' everywhere
-- 1. Update existing data
UPDATE public.profiles SET role = 'author' WHERE role = 'author';

-- 2. Drop existing check constraint (name from 00004_create_profiles)
ALTER TABLE public.profiles DROP CONSTRAINT IF EXISTS profiles_role_check;

-- 3. Add new check constraint with 'author' instead of 'author'
