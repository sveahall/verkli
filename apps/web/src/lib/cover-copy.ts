...
export function normalizeCoverCopy(value: unknown): CoverCopy {
  ...
  return {
    authorLine: clipText(raw.authorLine, AUTHOR_LINE_MAX),
    dustJacket: raw.dustJacket === true,
    flapText: clipText(raw.flapText, FLAP_TEXT_MAX),
  };
}
