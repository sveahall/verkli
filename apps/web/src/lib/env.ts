...
const SERVER_ENV_VARS = {
  ...
  ANALYTICS_IP_SALT: process.env.ANALYTICS_IP_SALT,
  ADMIN_API_KEY: process.env.ADMIN_API_KEY,
  STRIPE_SECRET_KEY: process.env.STRIPE_SECRET_KEY,
  STRIPE_WEBHOOK_SECRET: process.env.STRIPE_WEBHOOK_SECRET,
  STRIPE_PRICE_ID_PRO_WRITER: process.env.STRIPE_PRICE_ID_PRO_WRITER,
...
export function getServerEnv() {
  ...
  return {
    ...
    ANALYTICS_IP_SALT: SERVER_ENV_VARS.ANALYTICS_IP_SALT ?? undefined,
    ADMIN_API_KEY: SERVER_ENV_VARS.ADMIN_API_KEY ?? undefined,
    STRIPE_SECRET_KEY: SERVER_ENV_VARS.STRIPE_SECRET_KEY ?? undefined,
    STRIPE_WEBHOOK_SECRET: SERVER_ENV_VARS.STRIPE_WEBHOOK_SECRET ?? undefined,
    STRIPE_PRICE_ID_PRO_WRITER: SERVER_ENV_VARS.STRIPE_PRICE_ID_PRO_WRITER ?? undefined,
    STRIPE_SUCCESS_URL: SERVER_ENV_VARS.STRIPE_SUCCESS_URL ?? undefined,
    STRIPE_CANCEL_URL: SERVER_ENV_VARS.STRIPE_CANCEL_URL ?? undefined,
  };
}
