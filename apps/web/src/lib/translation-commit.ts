...
/** Deployment hold: remove only after approved S1 + DELETE and full-schema postverification. */
export function reviewedTranslationActivationReady(): boolean { return false; }
