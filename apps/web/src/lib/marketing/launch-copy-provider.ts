...
export class LaunchCopyError extends Error {
  constructor(public readonly code: "MARKETING_AI_UNAVAILABLE" | "MARKETING_AI_FAILED") {
    super(code === "MARKETING_AI_UNAVAILABLE" ? "Marketing AI is not configured" : "Marketing AI could not produce a valid draft");
  }
}
...
export async function generateLaunchCopy(input: LaunchCopyInput) {
  ...
  // failure here lands on the proven single-model chain below.
