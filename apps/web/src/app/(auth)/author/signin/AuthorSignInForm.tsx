...
export default function AuthorSignInForm() {
  ...
  return (
    <main
      ...
      className="relative flex min-h-screen min-h-dvh flex-col items-center justify-center overflow-hidden bg-background text-foreground transition-colors duration-300"
    >
      ...
      <header className="absolute left-6 top-6 z-30 flex items-center gap-3 sm:left-8 sm:top-8">
        ...
        <Link href="/author" className="btn-secondary text-[13px] gap-2 px-4 py-2.5">
        ...
        <div className="flex w-full flex-col items-center px-6 py-10 text-center sm:px-10 sm:py-12 md:px-12 md:py-14">
          ...
          <form onSubmit={handleSubmit} className="mt-8 flex w-full flex-col gap-5">
            ...
            <div className="flex items-center justify-between">
              ...
              <Link href="/author/forgot-password" className="text-sm text-slate-600 dark:text-white/50 transition hover:text-slate-900 dark:hover:text-white/70">
                Forgot password?
              </Link>
            </div>
          ...
          <p className="mt-8 text-sm text-slate-600 dark:text-white/40">
            ...
            <Link href="/author/signup" className="text-slate-900 dark:text-white/70 transition hover:text-slate-700 dark:hover:text-white">
              Sign up
            </Link>
          </p>
        </div>
