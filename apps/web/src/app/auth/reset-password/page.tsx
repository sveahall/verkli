    ...
    <main className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-[#0d0b14]">
      ...
      >
        <div className="flex w-full flex-col items-center px-12 py-14 text-center">
          <p className="text-base font-medium tracking-wide text-white/50">Set a new password</p>
          ...
          {hasSession === false && (
            <div className="mt-6 w-full rounded-lg bg-yellow-500/10 px-4 py-4 text-sm text-yellow-200">
