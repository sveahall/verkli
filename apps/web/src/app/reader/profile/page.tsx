    ...
    <main className="min-h-screen bg-[#050508] text-white">
      <div className="mx-auto w-full max-w-[1000px] px-6 py-12">
        <header className="mb-10">
          ...
          <p className="mt-2 text-[14px] text-white/50">Your public reader profile.</p>
        </header>
          ...
          <div className="flex flex-wrap items-center gap-6">
            <div className="h-24 w-24 overflow-hidden rounded-full border border-white/10">
              {avatarUrl ? (
                ...
                <div className="flex h-full w-full items-center justify-center text-[28px] font-semibold text-white/70">
            ...
            <div>
              ...
              <p className="text-[13px] text-white/50">@{username}</p>
              <p className="mt-3 max-w-[520px] text-[14px] text-white/60">{bio}</p>
            </div>
          </div>
        </div>
      </div>
