...
export default function WaitlistPageClient({ accessPending }: { accessPending: boolean }) {
    ...
    <main className="waitlist-page" id="top">
      <header className="wl-nav wl-shell">
        <a href="#top" className="wl-logo" aria-label="Verkli home">
          <Image src="/logo-dark.svg?v=20260916" alt="Verkli" width={1429} height={265} className="dark:hidden" priority /><Image src="/favicon.svg?v=20260916" alt="Verkli" width={1429} height={265} className="hidden dark:block" priority />
      ...
      <footer className="wl-footer wl-shell">
        <a href="#top" className="wl-logo" aria-label="Verkli home"><Image src="/logo-dark.svg?v=20260916" alt="Verkli" width={1429} height={265} className="dark:hidden" /><Image src="/favicon.svg?v=20260916" alt="Verkli" width={1429} height={265} className="hidden dark:block" /></a>
