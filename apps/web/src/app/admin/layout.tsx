      ...
      <div className="min-h-screen bg-background text-foreground lg:grid lg:grid-cols-[248px_minmax(0,1fr)]">
        <aside className="hidden border-r border-border bg-card px-4 py-8 lg:block">
          <div className="sticky top-8">
            ...
            >
              <Image src="/logo-dark.svg?v=20260916" alt="Verkli admin" width={1429} height={265} className="h-8 w-auto dark:hidden" priority />
              <Image src="/favicon.svg?v=20260916" alt="Verkli admin" width={1429} height={265} className="hidden h-8 w-auto dark:block" priority />
            </Link>
        ...
        <div className="min-w-0 border-b border-border bg-card px-5 py-4 lg:hidden">
          <div className="flex items-center justify-between">
            <Link href="/admin" className="flex min-h-11 items-center gap-3 rounded-lg focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring">
              <Image src="/logo-dark.svg?v=20260916" alt="Verkli" width={1429} height={265} className="h-7 w-auto dark:hidden" />
              <Image src="/favicon.svg?v=20260916" alt="Verkli" width={1429} height={265} className="hidden h-7 w-auto dark:block" />
