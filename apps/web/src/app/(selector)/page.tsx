...
export default function RoleSelection() {
  ...
  return (
    <main className={styles.page}>
      <header className={styles.header}><Link href="/" aria-label="Verkli home"><Image src="/logo-dark.svg?v=20260915" alt="Verkli" width={140} height={32} className="h-8 w-auto dark:hidden" priority /><Image src="/favicon.svg?v=20260915-white" alt="Verkli" width={140} height={32} className="hidden h-8 w-auto dark:block" priority /></Link><Link href="/pricing">Pricing <ArrowUpRight size={15} /></Link></header>
