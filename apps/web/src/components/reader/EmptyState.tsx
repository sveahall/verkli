...
type EmptyStateVariant = "default" | "subtle" | "centered";
...
type EmptyStateProps = {
  ...
  icon?: ReactNode;
  /** Visual variant: default, subtle (less prominent), or centered (full width center) */
...
export function SearchIcon({ className = "h-12 w-12" }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
      <path
        strokeLinecap="round"
