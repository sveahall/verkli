...
export default function AuthorCard({ name, avatar, genre, followers, href = "#" }: AuthorCardProps) {
  return (
    ...
    >
      <div className="flex h-12 w-12 items-center justify-center overflow-hidden rounded-full border border-white/60 bg-slate-100 text-[14px] font-semibold text-slate-600 dark:border-white/10 dark:bg-white/10 dark:text-white/70">
        {avatar ? (
