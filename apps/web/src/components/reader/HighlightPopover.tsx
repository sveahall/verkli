...
const COLORS: { value: HighlightColor; label: string; swatch: string }[] = [
  { value: "yellow", label: "Gul", swatch: "#facc15" },
  { value: "green", label: "Gr\u00f6n", swatch: "#86efac" },
  { value: "blue", label: "Bl\u00e5", swatch: "#93c5fd" },
  { value: "rose", label: "Rosa", swatch: "#fda4af" },
  { value: "purple", label: "Lila", swatch: "#c084fc" },
];
