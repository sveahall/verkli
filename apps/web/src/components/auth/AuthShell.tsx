    ...
    <main className={styles.shell}>
      <header className={styles.header}>
        <Link href={backHref} aria-label="Verkli home" className={styles.logo}>
          <Image src="/logo-dark.svg?v=20260916" alt="Verkli" width={1429} height={265} className="h-7 w-auto dark:hidden" priority />
          <Image src="/favicon.svg?v=20260916" alt="Verkli" width={1429} height={265} className="hidden h-7 w-auto dark:block" priority />
        </Link>
