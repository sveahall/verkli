      ...
      <div className={styles.workspaceBody}>
        ...
        <div className={styles.previewPanel} role="tabpanel" id="preview-panel" aria-labelledby={`preview-tab-${mode}`} tabIndex={0}>
          <div className={styles.manuscriptPage}>
            ...
            {mode === "translate" && <>
              <h3>A new language.<br /><em>The same beginning.</em></h3>
            ...
            {mode === "listen" && <>
              <h3>A story worth<br /><em>listening to.</em></h3>
          ...
          <aside className={styles.bookAside} aria-label="Example book edition">
            <div className={styles.previewBook}>
              <span>A NOVEL</span><strong>The shape<br />of <em>light.</em></strong>
              <div className={styles.bookSun} /><div className={styles.bookLandscape} />
