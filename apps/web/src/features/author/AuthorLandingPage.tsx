...
/* Tillräckligt många rader så att bokomslagen täcker hela mobilskärmen (repeterar) */
const gridRows = 20;
const gridCols = 10;
      ...
      >
        ...
        <div className="relative grid gap-10 lg:grid-cols-2 lg:items-center lg:gap-14">
          <div>
            ...
            <p className="mt-6 max-w-[380px] text-[16px] leading-[1.7] text-slate-600 dark:text-white/50">Join thousands of authors who use Verkli to turn their stories into content that reaches readers everywhere.</p>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between rounded-2xl bg-black/[0.04] px-6 py-5 backdrop-blur-sm dark:bg-white/[0.04]">
              ...
              <div className="h-8 w-px bg-black/[0.01] dark:bg-white/10" />
    ...
    <main className="author-light relative min-h-screen bg-background text-foreground transition-colors duration-300 -mt-[88px]">
      <div className="section-stack">
        ...
        <section ref={heroRef} onMouseMove={handleHeroMouseMove} className="relative isolate mx-auto flex min-h-screen w-full max-w-[1800px] flex-col items-center justify-center overflow-hidden px-6 pb-50 pt-[88px] text-center">
          ...
          <div className="mb-8 inline-flex items-center gap-2 rounded-full border border-black/10 bg-black/[0.02] px-4 py-2 backdrop-blur-sm transition-transform duration-300 hover:scale-105 dark:border-white/10 dark:bg-white/[0.03]">
          ...
          <div className="mt-10 flex flex-wrap items-center justify-center gap-3 sm:gap-4">
            <Link href="/author/signup" className="btn-primary min-w-[140px]">
              Sign up
            </Link>
            <Link href="/author/signin" className="btn-secondary min-w-[140px]">
              Sign in
            </Link>
          </div>
            ...
            <div className="group relative overflow-hidden rounded-[32px] bg-gradient-to-br from-black/[0.05] to-transparent p-8 dark:from-white/[0.06] dark:to-white/[0.02]">
              ...
              <div className="relative flex h-full flex-col justify-between">
                ...
                <div className="mt-6 flex -space-x-2">
                  ...
                  <div className="flex h-9 w-9 items-center justify-center rounded-full border-2 border-black/10 bg-black/[0.02] text-[11px] font-medium text-slate-600 dark:border-[#0a0a0f] dark:bg-white/10 dark:text-white/70">+2k</div>
                </div>
              </div>
            </div>
        ...
        <section className="mx-auto w-full max-w-[1200px] px-6 py-24">
          <div className="grid gap-12 lg:grid-cols-[1fr_1.2fr] lg:items-center">
            <div>
              ...
              <div className="mt-8">
                <Link href="/author/signup" className="btn-secondary">
                  Explore features
                </Link>
              </div>
            </div>
