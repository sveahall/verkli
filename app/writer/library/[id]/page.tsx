      ...
      <div className="mx-auto max-w-[1400px] px-6 py-12">
        ...
        <div className="mb-8 flex items-center gap-4">
          ...
          <button
            ...
            className="rounded-full border border-black/10 dark:border-white/10 bg-black/5 dark:bg-white/[0.03] px-6 py-2.5 text-[15px] font-medium text-slate-700 dark:text-white/70 transition-all hover:bg-black/10 dark:hover:bg-white/[0.06]"
          >
            Create section
          </button>
        </div>
        ...
        {unsectionedBooks.length > 0 && (
          <div className="mb-8 rounded-2xl border border-black/10 dark:border-white/[0.08] bg-gradient-to-b from-black/5 dark:from-white/[0.04] to-transparent p-6">
            <h3 className="mb-5 text-[18px] font-semibold text-slate-900 dark:text-white">Books</h3>
            <div 
                ...
                .map((shelfBook) => (
                  ...
                  >
                    <BookCard
                      book={shelfBook.book}
                      size="md"
                      onClick={() => router.push(`/writer/books/${shelfBook.book.id}`)}
                      onAction={(action) => {
                        if (action === "delete") {
          ...
          <div className="relative w-full max-w-[800px] rounded-3xl border border-black/10 dark:border-white/10 bg-white/95 dark:bg-[#0a0a0f]/95 p-8 shadow-2xl backdrop-blur-xl">
            ...
            <div className="space-y-4">
              <div>
                <input
                  ...
                  className="w-full rounded-xl border border-black/10 dark:border-white/10 bg-black/5 dark:bg-white/[0.04] px-4 py-2.5 text-[20px] font-semibold text-slate-900 dark:text-white outline-none transition-all focus:border-[#907AFF]/50 focus:bg-black/10 dark:focus:bg-white/[0.06]"
                />
              </div>
              <div>
                <input
            ...
            <div className="mt-8 flex justify-end gap-3">
              <button
                ...
                className="rounded-xl border border-black/10 dark:border-white/10 bg-black/5 dark:bg-white/[0.02] px-6 py-2.5 text-[14px] font-medium text-slate-700 dark:text-white/70 transition-all hover:bg-black/10 dark:hover:bg-white/[0.04]"
              >
                Cancel
              </button>
              <button
          ...
          <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
            <div className="relative w-full max-w-[500px] rounded-3xl border border-black/10 dark:border-white/10 bg-white/95 dark:bg-[#0a0a0f]/95 p-8 shadow-2xl backdrop-blur-xl">
              ...
              <input
                ...
                className="w-full rounded-xl border border-black/10 dark:border-white/10 bg-black/5 dark:bg-white/[0.04] px-4 py-3 text-[16px] text-slate-900 dark:text-white placeholder-slate-400 dark:placeholder-white/30 outline-none transition-all focus:border-[#907AFF]/50 focus:bg-black/10 dark:focus:bg-white/[0.06]"
                onKeyDown={(e) => {
