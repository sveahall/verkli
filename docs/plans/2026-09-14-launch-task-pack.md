...
Uppdragspaket skapat 14 september, status rättad 15 september 2026. Kompletterar [lanseringsplanen](2026-09-14-launch-command-plan.md). **Läs först [dagens status, SHA:er och granskarbrief](2026-09-15-launch-status.md).** R0 är committad och pushad på egen granskningsgren; inga nya paket är driftsatta. Codex äger alla åtta S1-åtgärder; Claude/S1 granskar utan produktionskodändringar. Rootarbetet från **Sammanställ plattformsplanen** väntar på separat integrationsreview.

## Releasekarta vid planering

| Plats / branch | Status | Hantering |
|---|---|---|
| `origin/platform`, `26d02239` | Färsk Git-fetch 15 sep bekräftar referensen; Node 22-fix `1293e720` ingår | Ingen ny runtime-SHA verifierad idag. Gitref och faktisk driftsversion redovisas separat. |
...
| `.claude/worktrees/translation-quality-20260914`, `codex/translation-quality-20260914` | Ren WIP-checkpoint `74aa9075`, 43 filer säkrade | Originalbas `61c833da`. Kvarstående måltextrace blockerar release; ingen blind cherry-pick av hela paketet. |
...
| `.claude/worktrees/release-integration-20260914` | Ren och pushad kandidat `e9544c19`, bas `26d02239` | Fyra QA-commits samt mejlretry/SSR. Lokala bevis från 14 sep; inte integrerad i platform eller verifierad live. |
...
Tiderna är grova arbetsintervall, inte summerbara löften om kalenderleverans. En agent får inte automatiskt ta ett ledigt ID; integrationsägaren bekräftar ägare och filer först. Detaljerade briefar nedan är ursprunglig omfattning; dagens smalare kandidat- och filgränser styr vad som får ändras.

| ID | Prioritet / föreslagen ägare | Leverans | Beroende | Intervall / startläge |
|---|---|---|---|---|
| **R0** | P0 / Codex release | Fyra QA-commits och granskade mejlretry-/SSR-fixar, `e9544c19` | Samlad integration och release-QA | COMMITTAD + PUSHAD granskningsgren; 14 sep: lint/tsc/build, 1 840 unit, 10/10 launch, 3/3 utan JS; ej live |
...
| **F1** | P0 / Codex integration + separat UI-review | Importåterhämtning, prisutkast, publiceringsfält och lokala fixtures; `3372782c` | Autentiserad resa och integration | COMMITTAD lokal kandidat; 15 sep lint/tsc/build + 1 840 unit; 14 sep browserbevis. Inga fler parallella filändringar |
...
| **S1** | P0 / Codex fixägare, Claude read-only granskare | Åtta rapporterade blockerare; S1-GATE `f9e53d8c`, S1-STORAGE `717a98ea` | SQL-behörighetsfix kräver granskat förslag/beslut; verkliga integritetsprov 04–06 | GRANSKNING MOTTAGEN / FIXAR PÅGÅR. GATE lokalt testad; inga blockerare markerade live-stängda |
...
Arbetsgång och releasekriterier (inventering, integration och lokal slutverifiering är utförda; kod-/dokumentöverlämning och push är utförda; gemensam integration och releasehandlingar återstår):
