...
Beslutsunderlag och arbetsplan, 14 september 2026. Ägare: Svea (produkt), Codex (integration och leverans). Dokumentet upprättades på `codex/launch-command-20260914`, med bas `26d02239`; den gemensamma kopian levereras på `codex/release-integration-20260914`. Planeringsarbetet har inte ändrat eller driftsatt produktkod. Statusuppgifterna om ocommittad kandidat nedan avser verifieringstillfället 14 september 15:49:48 UTC, före slutpaketeringen. Faktisk commit-SHA och pushstatus efter paketeringen redovisas i leveransens slutliga handoff; lokal verifiering innebär ingen produktionsrelease.
