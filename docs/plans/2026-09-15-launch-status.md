...
|---|---|---|
| 00 — profilroller/demo | Produktionsmetadata bekräftar bristen; triggerfrågan besvarad | Smal behörighetsfix med effektiva grants, legitima server-/profilflöden och verifiering efter applicering. |
